...
from network.serializers import (ContactSerializer,
                                 ...
                                 NetworkNodeSerializer, ProductSerializer)
...
class SerializerTests(TestCase):
    ...
    def test_network_node_create_serializer_update_method(self):
        ...
        validated_data = {"name": "Updated Name", "products": [self.product]}
    ...
    def test_serializer_partial_update(self):
        ...
        serializer = NetworkNodeCreateUpdateSerializer(
            instance=node, data=update_data, partial=True  # Важно для PATCH запросов
        )
        self.assertTrue(serializer.is_valid(), serializer.errors)
